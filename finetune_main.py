...
def main():
    ...
    parser.add_argument(
        ...
        choices=[
            'all_patch_reps_onelayer', 'all_patch_reps_twolayer',
            'avgpooling_patch_reps', 'all_patch_reps'],
        ...
        'all_patch_reps: Apply MLP (3-layer) to all features.'
        'all_patch_reps_onelayer: Apply MLP (1-layer) to all features.'
        'all_patch_reps_twolayer: Apply MLP (2-layer) to all features.'
    )
    ...
    parser.add_argument('--downstream_dataset', type=str, default='FACED',
                        help='[FACED, SEED-V, PhysioNet-MI, SHU-MI, ISRUC, '
